...
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  @media (max-width: 920px) and (hover: none) and (pointer: coarse) {
    ...
    /* 弹窗缩小 */
    #winModal .panel, #failModal .panel, #finalModal .panel { padding:24px 20px; max-width:90vw; }
    #winModal h2 { font-size:28px; }
    #winModal p { font-size:14px; }
    #finalModal h2 { font-size:36px; }
    #finalModal p { font-size:16px; }
    #introModal .panel { padding:16px 20px; max-width:90vw; }
    #onlineModal .panel { padding:16px 20px; max-width:90vw; }
    /* 主页适配 */
